                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-center">
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center w-full lg:w-auto">
                            ...
                            <button
                                type="button"
                                onClick={openAdd}
                                className="inline-flex items-center gap-2 rounded-full bg-navy-900 px-5 py-3 text-sm font-semibold text-cream-100 shadow-sm transition hover:bg-navy-800"
                            >
                        ...
                        <div className="w-full max-w-2xl rounded-[32px] bg-white p-6 shadow-2xl ring-1 ring-black/5">
                            <div className="flex items-center justify-between gap-4 pb-4 border-b border-cream-200">
                                <div>
                                    ...
                                    <p className="text-sm text-navy-500">
                                        Kelola nama, slug, dan ikon kategori
                                        menu.
                                    </p>
                                </div>
                                <button
