                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12 grid gap-10 lg:grid-cols-4">
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <span className="font-playfair text-2xl text-navy-900">
                                Hush & Co
                            </span>
                        </Link>
                        ...
                        <div className="flex items-center gap-3 text-sm text-navy-600">
                            ...
                            <div className="flex items-center gap-3">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    aria-label="Instagram Hush & Co"
                                    className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-cream-100 text-navy-900 transition hover:bg-navy-100"
                                >
                    ...
                    <div>
                        <p className="text-sm uppercase tracking-[0.24em] text-navy-500 mb-6">
                            Menu
                        </p>
