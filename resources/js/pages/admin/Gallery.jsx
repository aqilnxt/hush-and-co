...
export default function Gallery() {
    ...
    const handleFileChange = (e) => {
        ...
        if (file.size > MAX_FILE_SIZE_MB * 1024 * 1024) {
            toast.error(`Ukuran file melebihi batas ${MAX_FILE_SIZE_MB}MB`);
            e.target.value = '';
            return;
        }
    ...
    const handleAddPhoto = async (e) => {
        ...
        try {
            ...
            if (status === 413) {
                toast.error(
                    'Ukuran file terlalu besar. Coba kompres gambar atau gunakan file yang lebih kecil.',
                );
    ...
    const handleToggleActive = async (item) => {
        try {
            ...
            toast.success(
                item.is_active ? 'Foto dinonaktifkan' : 'Foto diaktifkan',
            );
            fetchGallery();
        } catch (err) {
            ...
            <div className="space-y-8">
                ...
                <div className="bg-white border border-cream-300 rounded-[32px] p-6 shadow-sm">
                    ...
                    <form
                        ...
                        className="grid gap-6 md:grid-cols-[1fr_2fr] items-start"
                    >
                        ...
                        <div className="bg-white border border-cream-300 rounded-[32px] py-16 text-center text-navy-400">
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <p className="text-xs text-navy-400 max-w-xs">
                                    Unggah foto suasana di atas untuk
                                    ditampilkan secara dinamis pada landing page
                                    kafe.
                                </p>
                            </div>
                        </div>
                                            ...
                                            {isEditing ? (
                                                ...
                                                <div>
                                                    <h4 className="font-semibold text-sm text-navy-900 line-clamp-1">
                                                        {item.title || (
                                                            <span className="italic text-navy-300 font-light">
                                                                Tidak ada judul
                                                            </span>
                                                        )}
                                                    </h4>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-sm text-navy-500 mt-1">
                                        Foto suasana yang dihapus akan terhapus
                                        permanen dari server dan tidak tampil
                                        lagi di landing page.
                                    </p>
                                </div>
